...
import { UserManagementApprovalModel } from '../../../gums_module_approved/user-management-approval/interface/user-management-approval.model';
...
@Component({
  selector: 'vex-application-create',
...
export class ApplicationCreateComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    private dialogRef: MatDialogRef<ApplicationMasterComponent>,
  ...
  ngOnInit() {
    if (this.defaults) {
      ...
      this.defaults = {} as ApplicationMasterModel;
    }
